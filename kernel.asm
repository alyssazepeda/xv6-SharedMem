...
80106d31:	74 62                	je     80106d95 <shm_open+0xa5>
  {
...
80106d94:	c3                   	ret    
  for(i = 0; i<64; i++)
80106d95:	ba f4 54 11 80       	mov    $0x801154f4,%edx
80106d9a:	31 c9                	xor    %ecx,%ecx
80106d9c:	eb 0d                	jmp    80106dab <shm_open+0xbb>
80106d9e:	66 90                	xchg   %ax,%ax
    for(j = 0; j < 64; j++) 
80106da0:	83 c1 01             	add    $0x1,%ecx
80106da3:	83 c2 0c             	add    $0xc,%edx
80106da6:	83 f9 40             	cmp    $0x40,%ecx
80106da9:	74 c7                	je     80106d72 <shm_open+0x82>
      if(shm_table.shm_pages[j].id == 0 && shm_table.shm_pages[j].frame == 0 && shm_table.shm_pages[j].refcnt == 0) 
80106dab:	8b 02                	mov    (%edx),%eax
80106dad:	85 c0                	test   %eax,%eax
80106daf:	75 ef                	jne    80106da0 <shm_open+0xb0>
80106db1:	8b 42 04             	mov    0x4(%edx),%eax
80106db4:	85 c0                	test   %eax,%eax
80106db6:	75 e8                	jne    80106da0 <shm_open+0xb0>
80106db8:	8b 42 08             	mov    0x8(%edx),%eax
80106dbb:	85 c0                	test   %eax,%eax
80106dbd:	75 e1                	jne    80106da0 <shm_open+0xb0>
        shm_table.shm_pages[j].id = id; //initialize id to the one passed to us
80106dbf:	8d 14 49             	lea    (%ecx,%ecx,2),%edx
80106dc2:	c1 e2 02             	shl    $0x2,%edx
80106dc5:	89 9a f4 54 11 80    	mov    %ebx,-0x7feeab0c(%edx)
...
80106de5:	00 
        shm_table.shm_pages[j].frame = kalloc(); //store the addesss in frame
80106de6:	8d 9a c8 54 11 80    	lea    -0x7feeab38(%edx),%ebx
        memset(shm_table.shm_pages[j].frame, 0, PGSIZE);
...
80106e05:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e0c:	00 
80106e0d:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e11:	05 00 00 00 80       	add    $0x80000000,%eax
80106e16:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80106e25:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e28:	83 82 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%edx)
        break;
80106e2f:	e9 3e ff ff ff       	jmp    80106d72 <shm_open+0x82>
...
80106e69:	74 1d                	je     80106e88 <shm_close+0x48>
...
80106e72:	85 c9                	test   %ecx,%ecx
80106e74:	7e 2a                	jle    80106ea0 <shm_close+0x60>
      {
        shm_table.shm_pages[i].refcnt--; //decrement the refcnt
80106e76:	83 e9 01             	sub    $0x1,%ecx
  for(i=0; i<64; i++) 
80106e79:	83 c2 01             	add    $0x1,%edx
        shm_table.shm_pages[i].refcnt--; //decrement the refcnt
80106e7c:	89 48 08             	mov    %ecx,0x8(%eax)
80106e7f:	83 c0 0c             	add    $0xc,%eax
  for(i=0; i<64; i++) 
80106e82:	83 fa 40             	cmp    $0x40,%edx
80106e85:	75 e4                	jne    80106e6b <shm_close+0x2b>
80106e87:	90                   	nop
        shm_table.shm_pages[i].frame = 0;
        break;
      }
...
80106e8f:	e8 ac d3 ff ff       	call   80104240 <release>
  return 0; //remains 0 bc we updated the values outputted in the tests in the code
}
80106e94:	83 c4 14             	add    $0x14,%esp
...
80106e9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        shm_table.shm_pages[i].id = 0;
80106ea0:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106ea3:	c1 e0 02             	shl    $0x2,%eax
80106ea6:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106ead:	00 00 00 
        shm_table.shm_pages[i].frame = 0;
80106eb0:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106eb7:	00 00 00 
        break;
80106eba:	eb cc                	jmp    80106e88 <shm_close+0x48>
